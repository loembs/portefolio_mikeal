    ...
    <main>
      ...
      <section className="mx-auto max-w-[1600px] px-6 md:px-10 pb-24 md:pb-32">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          ...
          />
          <img
            src="https://res.cloudinary.com/dlna2kuo1/image/upload/v1780762680/IMG_4396_wha5lf.jpg"
            alt="Performance réseau TikTok 5"
            loading="lazy"
            className="w-full h-full object-cover border border-border"
          />
          <img
            src="https://res.cloudinary.com/dlna2kuo1/image/upload/v1780762679/IMG_4397_kracpu.jpg"
            alt="Performance réseau TikTok 6"
            loading="lazy"
            className="w-full h-full object-cover border border-border"
          />
        </div>
