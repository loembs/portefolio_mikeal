...
export const videoProjects: VideoProject[] = [
  ...
  {
    id: 8,
    title: "Défilé Donatela",
    client: "Donatela",
    category: "Event",
    date: "2026",
    videoSrc: "https://res.cloudinary.com/dlna2kuo1/video/upload/v1780759946/IMG_4723_hfxgx5.mov",
    description:
      "Coverage du défilé de mode Donatela avec mise en scène cinématique.",
  ...
  {
    id: 9,
    title: "Review défilé Donatela",
    client: "Donatela",
    category: "Review",
    date: "2026",
    videoSrc: "https://res.cloudinary.com/dlna2kuo1/video/upload/v1780759872/IMG_4724_lpegyg.mov",
    description:
      "Review du défilé Donatela avec focus sur les détails et les moments clés.",
    tags: ["Fashion", "Review", "Social"],
    stats: {
      views: "8.2K",
      likes: "645",
      comments: "28",
  ...
  },
  {
    id: 10,
    title: "Immobilier",
    client: "Promotion immobilière",
    category: "Corporate",
    date: "2026",
    videoSrc: "https://res.cloudinary.com/dlna2kuo1/video/upload/v1780761525/IMG_4646_kaspwe.mov",
    description:
      "Visite virtuelle de propriété avec mise en valeur des espaces et ambiances.",
    tags: ["Immobilier", "Corporate", "Promotion"],
    stats: {
      views: "18.7K",
      likes: "1 240",
      comments: "89",
